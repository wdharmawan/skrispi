                ...
                <table class="table table-bordered text-center align-middle">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
                            ...
                            $sqlWhere .= " AND nama_merk LIKE '%$keyword%'"; // Filter berdasarkan nama merk
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-start">
                                            ...
                                            <p><strong>Gula Per 100ml:</strong> <?= format_angka($data['gula_per_100ml']) ?> g</p>
                                            <p><strong>Garam Per 100ml:</strong> <?= format_angka($data['garam_per_100ml']) ?> mg</p>
                                            <p><strong>Lemak Per 100ml:</strong> <?= $data['lemak_per_100ml'] ?> g</p>
                                            <p>
